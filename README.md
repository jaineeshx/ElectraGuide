...
│  1. Cache → 2. Gemini AI → 3. Mistral AI → 4. Hardcoded  │
├──────────────────────────────────────────────────────────┤
│                    GOOGLE SERVICES                        │
...
| Service | Usage |
| :--- | :--- |
| **Gemini AI** | Primary AI for chat, journey, scenarios, quiz |
| **Firebase Auth** | Google Sign-In, OAuth token verification |
| **Cloud Translation** | Multi-language text translation (22 Indian languages) |
| **Cloud Natural Language** | Sentiment analysis on user messages |
| **Google Analytics 4** | Frontend page view and event tracking |
...
| POST | `/api/booth` | Poling booth guide |
